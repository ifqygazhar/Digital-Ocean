...
wget --no-check-certificate -qO- https://github.com/minlearn/1keydd/raw/master/inst.sh | bash -s - -n $IPv4,$MASK,$GATE -t https://gz.tafnix.com/bios/ws2016-nKm.vhd.gz -w r00tRhel@12 > /dev/null